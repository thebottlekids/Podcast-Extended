...
- Ads are typically 15–120 seconds and contain sales intent plus CTAs, promo/discount codes, phone numbers, or sponsor framing such as "brought to you by". A bare URL, company name, or technical reference is not enough.
...
2) Strong cues: treat sponsor framing, promo/discount codes, phone numbers, or a URL paired with a clear CTA as strong indicators. Do not label a segment only because it contains a URL, company name, or generic words like "offer" or "deal".
